"""
Core OCR functionality for PDF OCR CLI.
"""
...
class OCRBase:
    ...
    def __init__(self, lang: str = 'tha', dpi: int = 300):
        ...
        Args:
            lang: Language code(s) for OCR (e.g., 'tha' for Thai, 'tha+eng' for Thai and English)
    ...
    def preprocess_image(self, image: Image.Image) -> Image.Image:
        ...
        # Subclasses may override this method to implement specific preprocessing
        return image
